...
public interface IEmailService
{
    ...
    Task SendWelcomeEmail(string email, string username, CancellationToken cancellationToken);
    Task ResendConfirmationEmail(string email, string username, CancellationToken cancellationToken);
